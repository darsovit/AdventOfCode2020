...
allergenMapKeys = list(allergenMap.allergens.keys())
allergenMapKeys.sort()
print( allergenMapKeys )
ingredientsInOrder = list(map(lambda x: allergenMap.allergens[x], allergenMapKeys))
print(','.join(ingredientsInOrder))
print(allergenMap.allergens)
